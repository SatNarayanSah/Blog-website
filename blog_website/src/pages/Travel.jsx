    ...
    <>
      <div className="p-4 container mx-auto">
        <div className="py-5 border-b-4 border-white">
          ...
          src="https://img.freepik.com/free-photo/travel-concept-with-worldwide-landmarks_23-2149153263.jpg?t=st=1733554562~exp=1733558162~hmac=20567d452258250bd7cdaf2b9cefee029f9481f02165435c565e1e7265307561&w=996" alt="image" />
          <div className="text-blue-950 font-bold text-3xl  py-5">Travel</div>
