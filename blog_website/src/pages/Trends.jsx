    ...
    <>
      <div className="p-4 container mx-auto">
        <div className="py-5 border-b-4 border-white">
          ...
          src="https://img.freepik.com/free-vector/data-trends-concept-illustration_114360-1499.jpg?t=st=1733554379~exp=1733557979~hmac=1ed9e2380d3e827c0c72d4881d53ec6e9a3e8ea1b7a6ce441155939c15d21c76&w=996" alt="image" />
          <div className="text-blue-950 font-bold text-3xl  py-5">Trends</div>
